    ...
    return (
        <footer className="relative mt-32 font-sans">
            ...
            <div className="bg-gradient-to-r from-[#003399] to-[#25d3af] text-white pt-32 pb-16 px-6">
                <div className="max-w-[1440px] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[1.5fr_1fr_1fr_1.5fr_2fr] gap-8 text-[13px]">
                    ...
                    <div className="space-y-12">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-[11px] opacity-70">Your online pharmacy</p>
                            </div>
                        </div>
                    ...
                    <ul className="space-y-3 font-medium opacity-90">
                        <li><a href="#" className="hover:opacity-100 hover:text-white transition-opacity flex items-center gap-2"><span className="opacity-50">—</span> About company</a></li>
                        <li><a href="#" className="hover:opacity-100 hover:text-white transition-opacity flex items-center gap-2"><span className="opacity-50">—</span> Delivery</a></li>
                        <li><a href="#" className="hover:opacity-100 hover:text-white transition-opacity flex items-center gap-2"><span className="opacity-50">—</span> Pick up from pharmacy</a></li>
                        <li><a href="#" className="hover:opacity-100 hover:text-white transition-opacity flex items-center gap-2"><span className="opacity-50">—</span> Payment</a></li>
                        <li><a href="#" className="hover:opacity-100 hover:text-white transition-opacity flex items-center gap-2"><span className="opacity-50">—</span> For legal entities</a></li>
                        <li><a href="#" className="hover:opacity-100 hover:text-white transition-opacity flex items-center gap-2"><span className="opacity-50">—</span> License</a></li>
                    </ul>

                    {/* Links Column 2 */}
                    <ul className="space-y-3 font-medium opacity-90">
                        <li><a href="#" className="hover:opacity-100 hover:text-white transition-opacity flex items-center gap-2"><span className="opacity-50">—</span> Feedback</a></li>
                        <li><a href="#" className="hover:opacity-100 hover:text-white transition-opacity flex items-center gap-2"><span className="opacity-50">—</span> Advertising on the site</a></li>
                        <li><a href="#" className="hover:opacity-100 hover:text-white transition-opacity flex items-center gap-2"><span className="opacity-50">—</span> Franchise</a></li>
                        <li><a href="#" className="hover:opacity-100 hover:text-white transition-opacity flex items-center gap-2"><span className="opacity-50">—</span> Vacancies</a></li>
                        <li><a href="#" className="hover:opacity-100 hover:text-white transition-opacity flex items-center gap-2"><span className="opacity-50">—</span> Privacy Policy</a></li>
                        <li><a href="#" className="hover:opacity-100 hover:text-white transition-opacity flex items-center gap-2"><span className="opacity-50">—</span> User Agreement</a></li>
                    </ul>
                    ...
                    <div className="space-y-8">
                        <div className="space-y-6">
                            <div className="flex items-start gap-3">
                                <Mail className="w-5 h-5 opacity-70 mt-0.5" />
                                <div>
                                    <p className="font-bold text-[14px] uppercase">INFO@RESTOLL.RU</p>
                                    <p className="text-[10px] opacity-60">Write to us</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-3">
                                <Phone className="w-5 h-5 opacity-70 mt-0.5" />
                                <div>
                                    <p className="font-bold text-[14px]">8-800-777-22-33</p>
                                    <p className="text-[10px] opacity-60">Round the clock</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-wrap gap-3">
                            {/* VK */}
                            <a href="#" className="w-9 h-9 rounded-full bg-[#2cdbbc] flex items-center justify-center text-white hover:bg-white hover:text-[#25d3af] transition-all group">
                            ...
                            {/* Facebook */}
                            <a href="#" className="w-9 h-9 rounded-full bg-[#2cdbbc] flex items-center justify-center text-white hover:bg-white hover:text-[#25d3af] transition-all">
                                <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
